  ...
  return (
    <>
        <div className='z-10 w-[240px] cursor-pointer drop-shadow-xl bg-[#fffcfcf7] rounded-2xl fixed top-[76px] bg-slate-100 left-2  px-4 py-4'> 
            ...
            <h1 className='font-bold text-lg block py-4 px-2 bg-[#f1f4fd] rounded-lg  text-red-400 '>
                <i className="fa-solid fa-fire-flame-curved mr-2 font-[20px] text-red-500"></i>
                Popular on BBLOG
            </h1>
            <ul>
                <li className='ml-4 p-2 text-[18px] hover:text-[#2d335e] font-semibold'>#sports</li>
                <li className='ml-4 p-2 text-[18px] hover:text-[#2d335e] font-semibold'>#showbiz</li>
                <li className='ml-4 p-2 text-[18px] hover:text-[#2d335e] font-semibold'>#politics_government</li>
                <li className='ml-4 p-2 text-[18px] hover:text-[#2d335e] font-semibold'>#technology</li>
                <li className='ml-4 p-2 text-[18px] hover:text-[#2d335e] font-semibold'>#civil_rights</li>
            </ul>
            ...
            <h1 className='font-bold text-lg block py-4 px-2 rounded-lg text-yellow-400 hover:bg-[#f1f4fd] '>
